...
\textcolor{red}{以下各项在 \texttt{make stage1b} 运行于真实数据后，
从 \texttt{reports/stage1b\_summary\_report.md} 补充实际数值。}

\begin{table}[htbp]
\centering
\small
\caption{Stage 1B 全量输出摘要（TODO: 运行管线后填充）}
...
\midrule
总样本数 & 3,206 & 经 QC 后 \\
strict reference 子集 N & \textcolor{red}{TODO} & CTRL + 严格标准 \\
phenotype Green\% & \textcolor{red}{TODO} & 全样本 \\
phenotype Yellow\% & \textcolor{red}{TODO} & 全样本 \\
phenotype Red\% & \textcolor{red}{TODO} & 全样本 \\
Severe instability N（\%）& \textcolor{red}{TODO} & 强制 Red 样本 \\
Mild instability升级 N（\%）& \textcolor{red}{TODO} & Green→Yellow \\
final\_zone Green\% & \textcolor{red}{TODO} & 含覆盖+置信 \\
final\_zone Yellow\% & \textcolor{red}{TODO} & \\
final\_zone Red\% & \textcolor{red}{TODO} & \\
yellow\_gray（indeterminate）\% & \textcolor{red}{TODO} & \\
High confidence\% & \textcolor{red}{TODO} & $\geq$0.75 \\
test\_result 梯度方向 & \textcolor{red}{TODO} & correct/non-monotone/reversed \\
结局模型 CV AUC & \textcolor{red}{TODO} & 预期 0.55--0.65 \\
验收判定 & \textcolor{red}{TODO} & Accept/Warn/Fail \\
\bottomrule
\end{tabular}
\end{table}
