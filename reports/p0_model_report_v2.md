...
|---|---|---|---|---|---|
| LASSO | with_bp | 0.5824 | 0.2842 | 0.1737 | 0.6222 ± 0.0295 |
| LASSO | no_bp | 0.5824 | 0.2842 | 0.1737 | 0.6222 ± 0.0295 |
| XGB | with_bp | 0.5828 | 0.2869 | 0.1799 | 0.6229 ± 0.0280 |
| XGB | no_bp | 0.5828 | 0.2869 | 0.1799 | 0.6229 ± 0.0280 |
...
|---|---|---|---|
| With BP | 0.5824 | 0.2842 | 0.1737 |
| No BP | 0.5824 | 0.2842 | 0.1737 |
| **Delta** | **+0.0000** | — | — |
...
| 版本 | AUC-ROC | AUPRC | Brier |
|---|---|---|---|
| With BP | 0.5828 | 0.2869 | 0.1799 |
| No BP | 0.5828 | 0.2869 | 0.1799 |
| **Delta** | **+0.0000** | — | — |
