...
| 版本类型 | 当前 | 下一版本 |
|---|---|---|
| 代码版本 | `v1.5.0`（Phase F Step4，数据驱动叙事，488测试）| `v2.0.0`（Phase G 方法学重大升级）|
...
| 论文准备 | `v1.5.0`（数据驱动方法学叙事）| `v2.0.0`（Phase G 三方法整合）|
| 方法学升级 | — | `v2.0.0`（结局锚定+Mahalanobis+一致性框架）|
